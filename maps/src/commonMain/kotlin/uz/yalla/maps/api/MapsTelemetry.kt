...
public interface MapsTelemetry {
    ...
    public fun onIconLoadFailed(icon: MapMarkerIcon, cause: Throwable) {}

    public fun onStyleLoadFailed(uri: String, cause: Throwable) {}

    public fun onCameraOpsCancelled(reason: String) {}

    public fun onUnsupportedFeature(feature: String, provider: String) {}
}
