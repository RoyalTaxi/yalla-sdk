...
public sealed class MapStyle {
    public data class Url(val lightUrl: String, val darkUrl: String) : MapStyle()

    public data class InlineJson(val lightJson: String, val darkJson: String) : MapStyle()

    public data object PlatformDefault : MapStyle()

    public companion object {
        public val CARTO: Url = Url(
