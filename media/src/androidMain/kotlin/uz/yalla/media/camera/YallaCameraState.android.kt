 ...
 *
 * Wraps CameraX lifecycle and provides observable Compose state for camera readiness,
 * capture progress, and active lens. Uses `mutableStateOf` for Compose recomposition.
 *
