...
public expect val boldFont: FontResource
public expect val mediumFont: FontResource
public expect val normalFont: FontResource
...
public fun rememberFontScheme(): FontScheme =
    FontScheme(
        title =
            FontScheme.Title(
                xLarge = TextStyle(fontSize = 30.sp, lineHeight = 30.sp, fontFamily = FontFamily(Font(boldFont))),
                large = TextStyle(fontSize = 22.sp, lineHeight = 22.sp, fontFamily = FontFamily(Font(boldFont))),
                base = TextStyle(fontSize = 20.sp, lineHeight = 20.sp, fontFamily = FontFamily(Font(boldFont)))
            ),
        body =
            FontScheme.Body(
