...
class SnackbarControllerTest {
    @Test
    fun show_emits_show_event_with_data() =
        runTest {
    ...
    @Test
    fun dismiss_emits_dismiss_event() =
        runTest {
            SnackbarController.events.test {
    ...
    @Test
    fun sendData_with_data_emits_show_event() =
        runTest {
    ...
    @Test
    fun sendData_with_null_emits_dismiss_event() =
        runTest {
            SnackbarController.events.test {
    ...
    @Test
    fun multiple_shows_are_not_deduped() =
        runTest {
    ...
    @Test
    fun show_followed_by_dismiss_emits_both_in_order() =
        runTest {
    ...
    @Test
    fun events_flow_is_cold_per_collector() =
        runTest {
