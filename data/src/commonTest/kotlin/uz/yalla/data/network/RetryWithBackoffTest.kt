...
class RetryWithBackoffTest {
    @Test
    fun shouldReturnResultOnFirstSuccessfulAttempt() =
        runTest {
            var callCount = 0
            val result =
    ...
    @Test
    fun shouldRetryOnIOExceptionWhenIdempotent() =
        runTest {
            var callCount = 0
            val result =
                retryWithBackoff(
    ...
    @Test
    fun shouldRetryOnSocketTimeoutWhenIdempotent() =
        runTest {
            var callCount = 0
            val result =
                retryWithBackoff(
    ...
    @Test
    fun shouldNotRetryWhenNotIdempotent() =
        runTest {
            var callCount = 0
    ...
    @Test
    fun shouldNotRetryNonRetryableExceptions() =
        runTest {
            var callCount = 0
    ...
    @Test
    fun shouldThrowAfterAllRetriesExhausted() =
        runTest {
            var callCount = 0
            assertFailsWith<IOException> {
                retryWithBackoff(
